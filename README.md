...
├── include/\
│ ├── primary/\
│ │ ├── [MarketData.hpp](https://github.com/manuelmusngi/systematic-options-cpp-framework/blob/main/include/primary/MarketData.hpp)\
│ │ ├── [OrderManager.hpp](https://github.com/manuelmusngi/systematic-options-cpp-framework/blob/main/include/primary/OrderManager.hpp)\
│ │ ├── [PositionManager.hpp](https://github.com/manuelmusngi/systematic-options-cpp-framework/blob/main/include/primary/PositionManager.hpp)\
│ │ ├── [Strategy.hpp](https://github.com/manuelmusngi/systematic-options-cpp-framework/blob/main/include/primary/Strategy.hpp)\
│ │ ├── [RiskManager.hpp](https://github.com/manuelmusngi/systematic-options-cpp-framework/blob/main/include/primary/RiskManager.hpp)\
│ │ └── [Logger.hpp](https://github.com/manuelmusngi/systematic-options-cpp-framework/blob/main/include/primary/Logger.hpp)\
│ ├── models/\
│ │ ├── Option.hpp\
│ │ └── Greeks.hpp\
│ └── utils/\
...
│ └── [IronCondorStrategy.cpp](https://github.com/manuelmusngi/systematic-options-cpp-framework/blob/main/strategies/IronCondorStrategy.cpp)\
└── config/\
